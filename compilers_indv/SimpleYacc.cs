...
public enum Tokens {
    ...
    COLUMN=19,MODULUS=20,IF=21,THEN=22,ELSE=23,WHILE=24,
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "write", "empty", "var", "varlist", "while", "repeat", "if", "stlist", 
      "$accept", "Anon@1", };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14},new int[]{-17,5,-6,66,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-27);
    states[7] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14,27,-14},new int[]{-6,8,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    ...
    states[34] = new State(new int[]{13,13,14,23,30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14,27,-14,23,-14},new int[]{-6,35,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    ...
    states[42] = new State(-32,new int[]{-19,43});
    states[43] = new State(new int[]{30,18},new int[]{-13,44,-3,47});
    states[44] = new State(new int[]{19,45,4,-33,10,-33,27,-33,23,-33});
    ...
    states[52] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14,27,-14,23,-14},new int[]{-6,53,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    states[53] = new State(new int[]{23,54,4,-35,10,-35,27,-35});
    states[54] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14,27,-14,23,-14},new int[]{-6,55,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    ...
    states[59] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,4,-14,10,-14,27,-14,23,-14},new int[]{-6,60,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    states[60] = new State(-29);
    states[61] = new State(-13);
    states[62] = new State(new int[]{30,18,3,4,5,33,11,37,12,42,21,50,24,57,26,62,27,-14,10,-14},new int[]{-17,63,-6,66,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-14,56,-15,61});
    states[63] = new State(new int[]{27,64,10,7});
    states[64] = new State(new int[]{30,18,28,19,17,20},new int[]{-2,65,-4,30,-5,29,-3,17});
    states[65] = new State(new int[]{13,13,14,23,4,-30,10,-30,27,-30,23,-30});
    ...
    rules[11] = new Rule(-6, new int[]{-16});
    rules[12] = new Rule(-6, new int[]{-14});
    rules[13] = new Rule(-6, new int[]{-15});
    ...
    rules[29] = new Rule(-14, new int[]{24,-2,25,-6});
    rules[30] = new Rule(-15, new int[]{26,-17,27,-2});
    rules[31] = new Rule(-10, new int[]{11,17,-2,18});
    rules[32] = new Rule(-19, new int[]{});
    rules[33] = new Rule(-12, new int[]{12,-19,-13});
    rules[34] = new Rule(-16, new int[]{21,-2,22,-6,23,-6});
    rules[35] = new Rule(-16, new int[]{21,-2,22,-6});
    rules[36] = new Rule(-13, new int[]{-3});
    rules[37] = new Rule(-13, new int[]{-13,19,-3});
  }
